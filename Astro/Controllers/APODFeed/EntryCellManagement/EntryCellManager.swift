...
class EntryCellManager {
    ...
    func addNextCell(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
    ...
    func fetchImageAndRenderEntry(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
    ...
    func saveYouTubeImageUnlessPictureAndRenderEntry(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
    ...
    func fetchImageFromInternetAndRenderEntry(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
    ...
    func renderEntry(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
