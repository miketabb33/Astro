...
//    
//    func assignCell(cell: APODEntryCell, indexPath: IndexPath, allAPODEntries: [APODEntryModel], tableView: UITableView, parent: UIViewController) {
...
//    func titleConfiguration(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath) {
...
//    }
//    
//    func imageConfiguration(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath) {
...
//    }
//    
//    func explanationConfiguration(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath) {
...
//    }
//    
//    func expandButtonConfiguration(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
...
//    func calculateCellHeightUnlessAlreadyCalculated(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath) {
