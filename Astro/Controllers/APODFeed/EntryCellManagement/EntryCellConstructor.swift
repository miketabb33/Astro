...
class EntryCellConstructor {
    ...
    func assignCell(cell: APODEntryCell, indexPath: IndexPath, allAPODEntries: Results<APODEntryRealm>, tableView: UITableView, parent: UIViewController) {
    ...
    func titleConfiguration(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath) {
    ...
    func imageConfiguration(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath) {
    ...
    func explanationConfiguration(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath) {
    ...
    func expandButtonConfiguration(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath, tableView: UITableView, parent: UIViewController) {
    ...
    func calculateCellHeightUnlessAlreadyCalculated(cell: APODEntryCell, allAPODEntries: Results<APODEntryRealm>, indexPath: IndexPath) {
