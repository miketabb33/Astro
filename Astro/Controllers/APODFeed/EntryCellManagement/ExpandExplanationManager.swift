...
//    
//    //GET TOGGLE POSITION
//    func getTogglePositionOfExplanation(cell: APODEntryCell, allAPODEntries: [APODEntryModel], indexPath: IndexPath) {
...
//    func toggleController(allAPODEntries: [APODEntryModel], indexPath: IndexPath, cell: APODEntryCell, tableView: UITableView) {
...
//    func expandExplanationLabel(allAPODEntries: [APODEntryModel], indexPath: IndexPath, cell: APODEntryCell, tableView: UITableView) {
...
//    func collapseExplanationLabel(allAPODEntries: [APODEntryModel], indexPath: IndexPath, cell: APODEntryCell, tableView: UITableView) {
//        
//        try! realmMethods.realm.write {
